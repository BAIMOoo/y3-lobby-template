...
y3editor.export_object_editor(
  output_path     = "<工程根>/.codex/skills/y3-terrain-template/library/.export_staging/<模板名>",
...
```bash
python .codex/skills/y3-terrain-template/scripts/export_terrain_template.py \
...
**dry-run（默认，必须先跑）**：
```bash
python .codex/skills/y3-terrain-template/scripts/import_terrain_template.py \
  --template "<模板名>" \
...
- 模板库根：`.codex/skills/y3-terrain-template/library/<模板名>/`
