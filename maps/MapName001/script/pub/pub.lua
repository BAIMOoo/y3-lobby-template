...
log.info('[MapName001][MatchTest] pub.lua module loaded')
...
y3.game:event('玩家-加入游戏', function(_, data)
    y3.player.with_local(function(local_player)
        match_log('[MapName001][MatchTest] player-join event:',
            'event_player=', data.player,
            'local_player=', local_player,
            'is_local=', data.player == local_player,
            'mode=', get_current_mode_id())
